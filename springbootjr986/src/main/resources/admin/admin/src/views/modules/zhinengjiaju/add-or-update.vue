	...
	<div class="addEdit-block" :style='{"padding":"30px 30px 0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="总评论数" prop="zongpinglunshu">
					<el-input v-model="ruleForm.zongpinglunshu" placeholder="总评论数" clearable  :readonly="ro.zongpinglunshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="总评论数" prop="zongpinglunshu">
					<el-input v-model="ruleForm.zongpinglunshu" placeholder="总评论数" readonly></el-input>
				</el-form-item>
			</template>

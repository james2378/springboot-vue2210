<template>
<div class="content box9" :style='{"alignContent":"flex-start","minHeight":"100vh","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230313/0b043a1da9554748b9083dd40edbb09a.jpg) no-repeat center top / 100% 100%,#040e29","display":"flex","width":"100%","position":"relative","height":"auto"}'>
	<!-- 标题 -->
	...
	<div class="tables">
        ...
        <el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"#333","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
          ...
          <el-table-column :resizable="true" :sortable="true" prop="zlfs" label="制冷方式"/>
            ...
            <div class="echarts4">
                <div id="bingxiangxinxiChart4" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts5">
                <div id="bingxiangxinxiChart5" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts6">
                <div id="bingxiangxinxiChart6" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts7">
            ...
            <div class="echarts9">
                <div id="zhinengjiajuChart9" style="width:100%;height:100%;"></div>
            </div>
...
export default {
  ...
  mounted(){
    ...
    this.bingxiangxinxiChat4();
    this.bingxiangxinxiChat5();
    this.bingxiangxinxiChat6();
    this.getzhinengjiajuCount();
    this.zhinengjiajuChat7();
    this.zhinengjiajuChat8();
    this.zhinengjiajuChat9();
  },
  created() {
    this.$nextTick(()=>{
		this.times()
...
//统计接口4
    bingxiangxinxiChat4() {
      this.$nextTick(()=>{
        ...
        var bingxiangxinxiChart4 = echarts.init(document.getElementById("bingxiangxinxiChart4"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                bingxiangxinxiChart4.setOption(option);
				

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    bingxiangxinxiChart4.resize();
                };
            }
        });
      })
...
//统计接口5
    bingxiangxinxiChat5() {
      this.$nextTick(()=>{
        ...
        var bingxiangxinxiChart5 = echarts.init(document.getElementById("bingxiangxinxiChart5"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                bingxiangxinxiChart5.setOption(option);


                  //根据窗口的大小变动图表
                window.onresize = function() {
                    bingxiangxinxiChart5.resize();
                };
            }
        });
      })
...
//统计接口6
    bingxiangxinxiChat6() {
      this.$nextTick(()=>{
        ...
        var bingxiangxinxiChart6 = echarts.init(document.getElementById("bingxiangxinxiChart6"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                bingxiangxinxiChart6.setOption(option);
				
				this.myChartInterval(2, option.yAxis.data, option.series[0].data, bingxiangxinxiChart6)

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    bingxiangxinxiChart6.resize();
                };
            }
        });
      })
...
//统计接口3
    zhinengjiajuChat9() {
      this.$nextTick(()=>{
        ...
        var zhinengjiajuChart9 = echarts.init(document.getElementById("zhinengjiajuChart9"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                zhinengjiajuChart9.setOption(option);
				

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    zhinengjiajuChart9.resize();
                };
            }
        });
      })
...
<style lang="scss" scoped>
	...
	// table
	.box9 .el-table /deep/ .el-table__header-wrapper thead {
				color: #999;
				font-weight: 500;
				width: 100%;
			}
	
	.box9 .el-table /deep/ .el-table__header-wrapper thead tr {
				background: none;
			}
	
	.box9 .el-table /deep/ .el-table__header-wrapper thead tr th {
				padding: 6px 0;
				background: none;
				border-color: #333;
	...
	.box9 .el-table /deep/ .el-table__header-wrapper thead tr th .cell {
				padding: 0 10px;
				word-wrap: normal;
	...
	.box9 .el-table /deep/ .el-table__body-wrapper tbody {
				width: 100%;
			}
	
	.box9 .el-table /deep/ .el-table__body-wrapper tbody tr {
				background: none;
			}
	
	.box9 .el-table /deep/ .el-table__body-wrapper tbody tr td {
				padding: 6px 0;
				color: #ccc;
				background: none;
				border-color: #333;
	...
	.box9 .el-table /deep/ .el-table__body-wrapper tbody tr:hover td {
				padding: 6px 0;
				color: #ccc;
				background: none;
				border-color: #333;
	...
	.box9 .el-table /deep/ .el-table__body-wrapper tbody tr td .cell {
				padding: 0 10px;
				overflow: hidden;
				word-break: break-all;
				white-space: normal;
